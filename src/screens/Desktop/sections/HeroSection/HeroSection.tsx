...
export const HeroSection = (): JSX.Element => {
  return (
    <section className="relative flex flex-col w-full max-w-3xl items-start gap-8 py-12 pl-[120px] max-[1500px]:pl-[80px] max-[1100px]:pl-[50px]  max-[680px]:pl-[25px] max-[1000px]:items-center max-[1000px]:gap-12 max-[1000px]:pr-[50px] max-[680px]:pr-[25px] max-[1000px]:max-w-[100%]  max-[680px]:gap-4">
      <div className=" flex flex-col items-start gap-[11px] w-full max-[1100px]:w-[500px] max-[1000px]:items-center max-[1000px]:text-center max-[1000px]:gap-4 max-[1000px]:w-[100%]">
        ...
        <p className="font-['Poppins',Helvetica] font-medium text-[#afaabf] text-[32px]  max-[1300px]:text-[28px] max-[1100px]:text-[24px] max-[1100px]:leading-[1.2] max-[680px]:text-[14px] max-[680px]:leading-[1.2]">
