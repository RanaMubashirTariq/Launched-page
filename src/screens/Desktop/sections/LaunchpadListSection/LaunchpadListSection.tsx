...
export const LaunchpadListSection = (): JSX.Element => {
  ...
  return (
    <footer className="flex justify-between w-full gap-5  pr-[234px] pl-[180px] pb-[36px] max-[1300px]:pr-[150px] max-[1300px]:pl-[100px] max-[1100px]:pr-[50px] max-[1100px]:gap-10 max-[1100px]:pl-[50px] max-[680px]:pr-[25px] max-[680px]:pl-[25px] max-[680px]:flex-col">
      <div className="flex flex-col w-[390px] max-[1500px]:w-[330px] gap-6">
        <div className="flex flex-col gap-3">
          <h3 className="font-medium text-xl text-white font-['Poppins',Helvetica]">
            Launchhood
          </h3>
          <p className="text-sm max-[1500px]:text-xs text-[#afaabf] font-medium font-['Poppins',Helvetica] leading-[27px]">
      ...
      <div className="flex gap-[94px] max-[1000px]:gap-10  max-[680px]:w-[100%] max-[680px]:justify-between max-[380px]:flex-wrap">
        {footerSections.map((section, index) => (
          ...
          >
            <h4
              className={`font-medium text-base max-[1500px]:text-sm text-white font-['Poppins',Helvetica] ${section.title === "Communities" ? "w-[103px]" : ""} leading-[27px] `}
            >
              {section.title}
            </h4>
            <div className="flex flex-col gap-[18px] max-[680px]:gap-2">
              {section.links.map((link, linkIndex) => (
                <a
                  ...
                  href="#"
                  className="text-base max-[1500px]:text-sm text-gray-400 font-['Segoe_UI-Regular',Helvetica] leading-[27px] hover:text-white transition-all duration-300 hover:underline hover:underline-offset-4 hover:decoration-1 hover:decoration-white "
                >
                  {link}
                </a>
              ))}
